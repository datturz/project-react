...
export default class Banner extends Component {
    render() {
        return (
            <React.Fragment>
                <div className="jumbotron bg-dark" style={{ height: '100%' }}>
                    <div className="container">
                        <div className='row'>
                            <div className='col-lg-6 text-center'>
                                <img src='https://cdn.shopify.com/s/files/1/0114/0994/8731/files/subscribe-product-1_large.png?v=1538980941' alt='jamu' />
                            </div>
                            <div className='col-lg-6 text-center' >
