...
export default class Arival extends Component{
    render(){
        return(
            <React.Fragment>
  ...
  <div className="container">
                            <div className="row">
                                <div className="col">
                                    <div className="card">
                                        <div className="card-header bg-light text-dark"><i className="far fa-paper-plane"></i> New Arrival.
                                    </div>
                                                ...
                                                <div className="card">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="row">
                                                            ...
                                                            <div className="col">
                                                                <a href="#a" className="btn btn-success btn-block"><i className="fas fa-cart-arrow-down"></i>Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="col-12 col-md-6 col-lg-4">
                                                <div className="card">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className="row">
                                                            <div className="col">
                                                                <a href="shoping-detail.html" className="btn btn-danger btn-block">99.00 $</a>
                                                                <br/>
                                                            </div>
                                                            <div className="col">
                                                                <a href="#a" className="btn btn-success btn-block">Add to cart</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
